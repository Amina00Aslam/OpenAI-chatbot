...
def order_document_sections_by_query_similarity(query_embedding: str, contexts: dict[(str, int, int), np.array]) -> \
list[(float, (str, int, int))]:
    """
...
if __name__ == '__main__':
    while True:
        # prompt = sys.argv[1]
        prompt = input("Ask a question from book *Rich Dad and Poor Dad*: ")  # Prompt the user for input
